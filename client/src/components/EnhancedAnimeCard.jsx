...
import { useHoverAnimation, usePrefersReducedMotion, usePrefetch } from '../hooks/useAnimation';
      ...
      <div className="relative aspect-[3/4] overflow-hidden">
        ...
        >
          <div className="flex items-center gap-3">
            ...
            >
              <Plus className={`w-5 h-5 ${isInWatchlist ? 'rotate-45' : ''} transition-transform`} />
            </motion.button>
          </div>
        </motion.div>
      </div>
